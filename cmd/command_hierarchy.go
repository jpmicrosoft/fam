...
var namespaceCatalog = map[string]namespaceMetadata{
	...
	"agent365 blueprint":                {Short: "Inspect and validate Microsoft Entra Agent ID blueprints. Read-only; not a deployment source."},
	...
	"agent365 binding":                  {Short: "Compare Foundry identities with existing blueprints. Read-only; no binding operation is available."},
