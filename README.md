...
./scripts/install.sh --version v0.14.0 --install-dir "$HOME/.local/bin"
...
| `Could not determine latest release` | Check GitHub access/private-repo authentication, or pass a known tag such as `-Version v0.14.0` |
